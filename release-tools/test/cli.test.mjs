...
test('readManifest accepts the exact canonical product manifest',async()=>{const fixture=await createReleaseFixture();assert.equal((await readManifest(`${fixture.root}/manifest.json`)).manifest.catalog.file,'grounds-resourcepack-catalog-v0.1.0.jar');});
